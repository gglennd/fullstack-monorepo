...
function CalendarRoot(props: { className?: string; rootRef?: React.Ref<HTMLDivElement>; [key: string]: unknown }) {
...
function CalendarChevron(props: { className?: string; orientation?: string; [key: string]: unknown }) {
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Root: CalendarRoot as never,
        Chevron: CalendarChevron as never,
        DayButton: CalendarDayButtonWrapper as never,
        WeekNumber: CalendarWeekNumber as never,
        ...components,
      }}
      {...props}
    />
...
function CalendarDayButtonWrapper({ locale, ...props }: React.ComponentProps<typeof DayButton> & { locale?: Partial<Locale> }) {
